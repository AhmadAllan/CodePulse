...
const ChatPage = () => {
  // State for selected chat (project or user)
  const [selectedChat, setSelectedChat] = useState('project');

  // State for project chat messages
  ...
  // State for user chat messages
  const [userChatMessages, setUserChatMessages] = useState([]);

  // State for new message input
  const [newMessage, setNewMessage] = useState('');

  // Function to handle chat switch
  ...
  // Function to render chat messages based on selected chat
